...
functions {
  ...
  real partial_log_lik_lpmf(array[] int seq, int start, int end,
                            ...
                            data vector Z_1_muDKDA_3, vector r_1_muDKDA_1,
                            ...
                            vector r_2_muOppose_3, data array[] int J_3,
...
model {
  ...
  if (!prior_only) {
    target += reduce_sum(partial_log_lik_lpmf, seq, grainsize, ncat, Y,
                         ...
                         Z_1_muDKDA_2, Z_1_muDKDA_3, r_1_muDKDA_1,
                         r_1_muDKDA_2, r_1_muDKDA_3, J_2, Z_2_muOppose_1,
                         Z_2_muOppose_2, Z_2_muOppose_3, r_2_muOppose_1,
                         r_2_muOppose_2, r_2_muOppose_3, J_3,
                         Z_3_muSupport_1, Z_3_muSupport_2, Z_3_muSupport_3,
                         r_3_muSupport_1, r_3_muSupport_2, r_3_muSupport_3);
  }
