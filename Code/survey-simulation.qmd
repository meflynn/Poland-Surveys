...
Nlist <- c(1600, 2560, 3040)

# First runt he function to simulate the results,
powtest <- power_sim(N = Nlist,
                     iters = 10,
                     seed = 3353,
                     beta_p_1 = rnorm(1, 1.0, 0.05),
                     beta_p_2 = rnorm(1, 0.5, 0.05),
                     beta_p_3 = rnorm(1, 0.1, 0.03),
                     beta_p_age_2 = rnorm(1, -0.12, 0.03), 
                     beta_p_age_3 = rnorm(1, -0.09, 0.03), 
                     beta_p_age_4 = rnorm(1, -0.05, 0.02), 
                     beta_p_age_5 = rnorm(1, 0.11, 0.04), 
                     beta_p_age_6 = rnorm(1, 0.19, 0.04), 
                     ...
                     beta_n_1 = rnorm(1, -0.9, 0.05), 
                     beta_n_2 = rnorm(1, -0.2, 0.02), 
                     beta_n_3 = rnorm(1, -0.5, 0.1), 
                     beta_n_age_2 = rnorm(1, 0.09, 0.03), 
                     beta_n_age_3 = rnorm(1, -0.01, 0.04), 
                     beta_n_age_4 = rnorm(1, -0.10, 0.04), 
                     beta_n_age_5 = rnorm(1, -0.18, 0.03), 
                     beta_n_age_6 = rnorm(1, -0.06, 0.03), 
                     beta_n_contact = rnorm(1, 0.18, 0.02), 
                     beta_n_benefits = rnorm(1, -0.42, 0.02), 
                     ...
                     beta_p_I = rnorm(1, -2.0, 0.02), 
                     beta_n_I = rnorm(1, -0.5, 0.01), 
                     I_error = rnorm(1, 0, 0.05))
