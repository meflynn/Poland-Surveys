...
functions {
  ...
  real partial_log_lik_lpmf(array[] int seq, int start, int end,
                            ...
                            data vector Z_1_muOppose_4,
                            data vector Z_1_muOppose_5,
                            data vector Z_1_muOppose_6,
                            data vector Z_1_muSupport_7,
                            data vector Z_1_muSupport_8,
                            data vector Z_1_muSupport_9, vector r_1_muDKDA_1,
                            vector r_1_muDKDA_2, vector r_1_muDKDA_3,
                            vector r_1_muOppose_4, vector r_1_muOppose_5,
                            vector r_1_muOppose_6, vector r_1_muSupport_7,
                            vector r_1_muSupport_8, vector r_1_muSupport_9) {
    real ptarget = 0;
    int N = end - start + 1;
    ...
    for (n in 1 : N) {
      // add more terms to the linear predictor
      int nn = n + start - 1;
      muOppose[n] += r_1_muOppose_4[J_1[nn]] * Z_1_muOppose_4[nn]
                     + r_1_muOppose_5[J_1[nn]] * Z_1_muOppose_5[nn]
                     + r_1_muOppose_6[J_1[nn]] * Z_1_muOppose_6[nn];
    }
    for (n in 1 : N) {
      // add more terms to the linear predictor
      int nn = n + start - 1;
      muSupport[n] += r_1_muSupport_7[J_1[nn]] * Z_1_muSupport_7[nn]
                      + r_1_muSupport_8[J_1[nn]] * Z_1_muSupport_8[nn]
                      + r_1_muSupport_9[J_1[nn]] * Z_1_muSupport_9[nn];
    }
    for (n in 1 : N) {
...
model {
  ...
  if (!prior_only) {
    target += reduce_sum(partial_log_lik_lpmf, seq, grainsize, ncat, Y,
                         ...
                         Z_1_muOppose_5, Z_1_muOppose_6, Z_1_muSupport_7,
                         Z_1_muSupport_8, Z_1_muSupport_9, r_1_muDKDA_1,
                         r_1_muDKDA_2, r_1_muDKDA_3, r_1_muOppose_4,
                         r_1_muOppose_5, r_1_muOppose_6, r_1_muSupport_7,
                         r_1_muSupport_8, r_1_muSupport_9);
  }
