...
@eq-distance-equation shows how we calcualte the distance effect. $\mathbb{E}[Y_{t,r,p,i,5km}]$ is the expected value of $Y$ for treatment group $t$, for response $r$, in province $p$, for draw/row $i$ for the 5 km model. Similarly, $\mathbb{E}[Y_{t,r,p,i,100km}]$ is the expected value of $Y$ for treatment group $t$, for response$r$, in province $p$, for draw/row $i$ for the 100 km model. 
