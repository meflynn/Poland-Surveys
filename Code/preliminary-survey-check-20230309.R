...
data <- readxl::read_excel(here("Data/raw-data/Poland Survey 2023_March 9, 2023_08.54.xlsx")) |>
  slice(-c(1))
...
# First group
length(data$Q61[!is.na(data$Q61)])/length(data$Q61)
length(data$Q63[!is.na(data$Q63)])/length(data$Q63)

# Second group
length(data$Q64[!is.na(data$Q64)])/length(data$Q64)
length(data$Q65[!is.na(data$Q65)])/length(data$Q65)

# Third group
length(data$Q68[!is.na(data$Q68)])/length(data$Q68)
length(data$Q69[!is.na(data$Q69)])/length(data$Q69)

# Fourth group
length(data$Q66[!is.na(data$Q66)])/length(data$Q66)
length(data$Q67[!is.na(data$Q67)])/length(data$Q67)
